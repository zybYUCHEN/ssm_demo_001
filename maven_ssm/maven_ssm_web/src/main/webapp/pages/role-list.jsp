...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/find/${role.id}" class="btn bg-olive btn-xs">修改角色权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/role/find?pageNum=1&pageSize=${pageInfo.pageSize}&term=${term}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/role/find?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}&term=${term}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="${pageContext.request.contextPath}/role/find?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}&term=${term}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/role/find?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}&term=${term}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/role/find?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}&term=${term}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
		...
		<script>
            ...
            function search() {
                var term = $("#term").val();
                location.href="${pageContext.request.contextPath}/role/find?pageNum=${pageInfo.pageNum}&pageSize=${pageInfo.pageSize}&term="+term;
            }
            <%--切换pageSize，每页展示数据量--%>
            function changPageSize(pageNum){
                var pageSize = $("#changPageSize").val();
                location.href="${pageContext.request.contextPath}/role/find?pageNum="+pageNum+"&pageSize="+pageSize+"&term=${term}";
            }
