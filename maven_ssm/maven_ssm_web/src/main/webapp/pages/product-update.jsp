					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								placeholder="${product.productNum}" readonly="readonly" value="${product.productNum}">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="departureTime" placeholder="${product.departureTimeStr}" value="${product.departureTimeStr}">
							</div>
						</div>
