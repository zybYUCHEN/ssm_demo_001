			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/permission/find?pageNum=1&pageSize=${pageInfo.pageSize}&term=${term}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/permission/find?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}&term=${term}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="${pageContext.request.contextPath}/permission/find?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}&term=${term}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/permission/find?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}&term=${term}">下一页</a></li>
