                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${pageInfo.list}" var="product">
                                <tr>
                                    ...
                                    <td class="text-center" id="status">${product.productStatusStr }</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs">订单</button>
                                        <button type="button" class="btn bg-olive btn-xs">详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="update('${product.id}')">编辑</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    ...
    function tigger(status) {
        ...
        if (status==1){
            if (confirm("确定要开启吗？")) {
                location.href = "${pageContext.request.contextPath}/product/update/"+status+"/" + list;
            }
        } else {
            if (confirm("确定要关闭吗？")) {
                location.href = "${pageContext.request.contextPath}/product/update/"+status+"/" + list;
    ...
    function deleteS() {
        ...
        if (!flag) {
            ...
            if (confirm("确定要删除吗？")) {
                location.href = "${pageContext.request.contextPath}/product/delete/" + list;
            }
        }
    }
