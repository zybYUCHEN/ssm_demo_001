        ...
        <form
            ...
            <section class="content">
                ...
                <table id="dataList"
                    ...
                    <tbody>
                    <c:forEach items="${psList}" var="permission">
                        <tr>
                            <td>
                                <input name="ids" class="ids" ${permission.status==1?"checked":""} type="checkbox"
                                       value="${permission.id}">
                            </td>
                            <td>${permission.id}</td>
                ...
                <div class="box-tools text-center">
                    <input type="button" class="btn bg-maroon" onclick="saveRoles()" value="保存"/>
