...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/permission/update/${permission.id}"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="permissionName"
                                   placeholder="${permission.permissionName}" value="${permission.permissionName}"
                                   readonly="readonly">
                        </div>
                        <div class="col-md-2 title">RUL</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="url"
                                   placeholder="${permission.url}" value="${permission.url}">
                        </div>
